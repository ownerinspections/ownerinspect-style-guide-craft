  ...
  return (
    <div className="space-y-8">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-slate-800 mb-4">Marketing Assets</h1>
      ...
      {marketingAssets.map((category) => (
        <Card key={category.category} className="p-6">
          <div className="mb-6">
            <h2 className="text-2xl font-semibold text-slate-800 mb-2">{category.category}</h2>
            ...
            {category.items.map((item) => (
              <Card key={item.name} className="p-4 hover:shadow-md transition-shadow">
                <div className="flex justify-between items-start mb-3">
                  <h3 className="font-medium text-slate-800 leading-tight">{item.name}</h3>
      ...
      <Card className="p-8 mt-12">
        <h2 className="text-2xl font-semibold text-slate-800 mb-6">Marketing Guidelines</h2>
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <h3 className="font-semibold text-slate-700 mb-3">Brand Message Consistency</h3>
          ...
          <div>
            <h3 className="font-semibold text-slate-700 mb-3">Visual Standards</h3>
            <ul className="space-y-2 text-slate-600 font-inter">

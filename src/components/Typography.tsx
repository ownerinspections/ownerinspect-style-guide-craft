  ...
  return (
    <section className="space-y-12">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <Card className="p-8">
          <h3 className="text-2xl font-bold text-slate-800 mb-6 font-degular">Primary Font</h3>
        ...
        <Card className="p-8">
          <h3 className="text-2xl font-bold text-slate-800 mb-6 font-degular">Secondary Font</h3>
          <div className="space-y-4">
      ...
      {/* Type Scale */}
      <Card className="p-8">
        <h3 className="text-2xl font-semibold text-slate-800 mb-8 font-degular">Typography Scale</h3>
